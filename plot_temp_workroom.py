...
ax1.set_title("workroom " + yesterday.strftime("%Y-%m-%d"))
ax1.set_xlabel("time")
...
plt.savefig("/home/takuya/homeHK/temperature_graph/workroom_" + yesterday.strftime("%Y-%m-%d") + ".jpg")
...
data = {'message': f'\nTemperature history of workroom on ' + yesterday.strftime("%a %b %d, %Y")}
files = {"imageFile":open('/home/takuya/homeHK/temperature_graph/workroom_' + yesterday.strftime("%Y-%m-%d") + ".jpg", 'rb')}
