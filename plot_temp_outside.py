...
ax.scatter(time_array, temperature_array, s=60, c='k', marker='x')
ax.set_xlim(span)

ax.set_title("outside " + yesterday.strftime("%Y-%m-%d"))
ax.set_xlabel("time")
...
plt.savefig("/home/takuya/homeHK/temperature_graph/outside_" + yesterday.strftime("%Y-%m-%d") + ".jpg")
...
data = {'message': f'\nTemperature history of outside on ' + yesterday.strftime("%a %b %d, %Y")}
files = {"imageFile":open('/home/takuya/homeHK/temperature_graph/outside_' + yesterday.strftime("%Y-%m-%d") + ".jpg", 'rb')}
